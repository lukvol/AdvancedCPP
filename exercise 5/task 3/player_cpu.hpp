...
public:
	 ...
	 */
	player_cpu(int player_mode = 0) : mode(player_mode) {
 ...
 */
template<typename F>
int player_cpu<F>::play(const F &field) {
 ...
 */
template<typename F>
int player_cpu<F>::can_win(int player, const F &field) {
 ...
 */
template<typename F>
int player_cpu<F>::recursive_can_win(int player, int x, int y, int x_dir, int y_dir, const F &field) {
 ...
 */
template<typename F>
int player_cpu<F>::height_for_row(int x, const F &field) {
 ...
 */
template<typename F>
int player_cpu<F>::get_player_nr(const F &field){
	int cnt=0;
	for(int i=0; i<F::width;i++){
