...
static playerFH<computerplayer> registerPlayer;
 ...
 */
int computerplayer::can_win(int player, const playfield &field) {
 ...
 */
int computerplayer::recursive_can_win(int player, int x, int y, int x_dir, int y_dir, const playfield &field) {
 ...
 */
int computerplayer::height_for_row(int x, const playfield &field) {
 ...
 */
int computerplayer::get_player_nr(const playfield &field){
	int cnt=0;
	for(int i=0; i<playfield::width;i++){
...
/**
 * This function is make method for the conmputer player used in the playerfactory
 * @param string to get number of player
 * @return a new instance of a player object
 */
player *computerplayer::make(const char *plr){
	if(plr[0]!='T') return NULL;
